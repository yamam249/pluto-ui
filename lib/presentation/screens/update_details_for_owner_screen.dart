...
class _UpdateDetailsForOwnerScreenState
  ...
  Widget build(BuildContext context) {
    ...
    final errorColor = AppTheme.kColorDanger;
    final successColor = AppTheme.kColorSuccess;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _sectionTitle("Tenant Information", fontColor ?? Colors.grey),
            _buildCard(
              cardColor,
              Row(
                children: [
            ...
            const SizedBox(height: 20),
            _sectionTitle("Apartment Details", fontColor ?? Colors.grey),
            _buildCard(
              cardColor,
              Column(
                children: [
  ...
  Widget _buildPriceRow(
    ...
    final nights = _calculateTotalNights(from, to);
    final totalPrice =
        nights *
        (double.tryParse(
              widget.updateRegistrationModel.booking.apartment.price.toString(),
            ) ??
            0);
    return _infoRow(
      ...
      children: [
        ...
        Expanded(
          child: OutlinedButton(
            ...
            child: (globalLoading && _isDeleting)
                ? SizedBox(
                    height: 20,
                    width: 20,
                    child: CircularProgressIndicator(
  ...
  // Helper Widgets remain largely the same, but use passed colors
  Widget _statusBanner(String text, Color color) {
    return Container(
      width: double.infinity,
      padding: const EdgeInsets.all(12),
